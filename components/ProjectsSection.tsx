      ...
      <div className="grid grid-cols-1 gap-6">
        {projects.map((project, idx) => {
          ...
          return (
            <article
              key={project.slug}
              className="border border-border bg-bg-raised/20 font-mono transition-colors hover:border-text-secondary/60"
            >
              ...
              <div className="p-5 md:p-6 space-y-3">
                ...
                <p className="text-sm text-text-primary/90 leading-relaxed max-w-[70ch]">
                  {project.description}
                </p>
