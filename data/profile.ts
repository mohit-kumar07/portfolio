...
export const profile: Profile = {
  ...
  description: [
    ...
    "Comfortable across the stack: builds REST APIs and backend services, and has contributed to a production Next.js/Supabase migration for a live e-commerce platform.",
